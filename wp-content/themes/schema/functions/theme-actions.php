...
<div class="top"></div>
<div class="top"><?php echo $mts_options['mts_copyrights']; ?></a></div>
</div>
<!--end copyrights-->
<?php }
}
    		...
    		<div class="shareit">
    			...
    			<?php if($mts_options['mts_pinterest'] == '1') { 
    				...
    				<span class="share-item pinbtn">
    					<a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php echo $media; ?>&amp;description=<?php the_title(); ?>" class="pin-it-button" count-layout="horizontal">Pin It</a>
    				</span>
    			<?php } ?>
    		</div>
    		<!-- end Share Buttons -->
